# PyMVPA BIDS App
PyMVPA is a Python package that facilitates MultiVariate Pattern Analysis. In order to run this app, you need preprocessed data generated by fmriprep. When you're ready, run the app at its two analysis levels in order:
- **participant_prep**:
- **participant_test**:
## Description
## Documentation
